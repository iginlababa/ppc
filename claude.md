...
- **CSV:** `data/raw/stream_*_nvidia_rtx5060_*.csv`
- **Processed:** `data/processed/e1_stream_summary.csv`

### E2 — DGEMM (Dense Matrix Multiply)
- **Status:** COMPLETE — 2026-03-14
- **Platform:** nvidia_rtx5060 (locked clocks, warmup-50 protocol §9.1)
...
- **Raw CSVs:** `data/raw/dgemm_*_nvidia_rtx5060_20260314.csv`
...
- **Methodology note:** PLATFORM constant in `process_e2.py` was `nvidia_rtx5060_locked` — corrected to `nvidia_rtx5060`
...
- **Platform:** nvidia_rtx5060 (no locked clocks — sudo unavailable; adaptive warmup CV<2%)
...
- **Raw CSVs:** `data/raw/stencil_*_nvidia_rtx5060_20260315.csv`
...
- **Raw CSVs:** `data/raw/nbody_{native,julia}_nvidia_rtx5060_20260316.csv`
...
- **Raw CSVs:** `data/raw/bfs_{native,julia}_nvidia_rtx5060_20260316.csv`
...
- **Raw CSVs:** `data/raw/sptrsv_{native,kokkos,raja,julia}_nvidia_rtx5060_20260316.csv`
